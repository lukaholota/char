...
import { Flag, Loader2, MessageSquareReply, Trash2 } from "lucide-react";
import { toast } from "sonner";
import { Button } from "@/components/ui/button";
import { addContentComment, deleteContentComment, voteContentComment } from "@/lib/actions/content-discussion-actions";
import type { DiscussionCommentView } from "@/lib/logic/content-discussion";
...
type CommentFormProps = { target: string; parentCommentId: number | null; placeholder: string; onDone: () => void };

export function DiscussionCommentForm({ target, parentCommentId, placeholder, onDone }: CommentFormProps) {
