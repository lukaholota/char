...
import { RoundTokenMedallion } from "@/components/bestiary/RoundTokenMedallion";
...
///
/// Токени 5etools (231 істота) з цього правила виходять: вони круглі й намальовані під круг,
/// тож ідуть власною дорогою — див. RoundTokenMedallion.
export function CreatureMedallion({
  creature,
  visual,
}: {
  creature: Pick<CreatureData, "name" | "imageUrl" | "imageShape">;
  ...
  if (creature.imageShape === "round" && creature.imageUrl) {
    return <RoundTokenMedallion src={creature.imageUrl} alt={creature.name} />;
  }
