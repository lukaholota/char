      ...
      >
        ...
        <div className="relative group">
            ...
            <button
                ...
                className="absolute top-3 right-3 z-50 glass-panel inline-flex h-8 w-8 items-center justify-center rounded-full border border-slate-700/50 text-slate-200/90 hover:text-teal-300 transition-all opacity-0 group-hover:opacity-100 sm:opacity-100"
                aria-label="Закрити"
            >
                <X className="h-4 w-4" />
            </button>
