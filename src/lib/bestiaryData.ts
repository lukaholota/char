...
export type CreatureData = {
  ...
  imageWidth?: number;
  imageHeight?: number;
  /// `round` — токен 5etools: кругла картина у власному кільці, з прозорими кутами. Малюється
  /// як є, без нашої рамки: і квадратне кадрування, і друге кільце поверх псували б її.
  imageShape?: "round";
