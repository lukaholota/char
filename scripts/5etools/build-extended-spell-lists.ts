...
/// власника уникає. `BMT` тут спершу не було свідомо, «бо жодного заклинання з тієї книги в
/// каталозі 2014 немає, і збірка впаде, якщо воно там колись зʼявиться» — KR17.3 засіяв
/// `Antagonize`, `Spray of Cards` і `Spirit of Death`, сторож спрацював, код додано.
