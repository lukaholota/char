...
/// `BMT` додано 2026-08-29 разом із генератором: KR17.3 засіяв у каталог 2014 заклинання
/// з «The Book of Many Things», і доти відсутній код валив збірку — рівно як задумано.
