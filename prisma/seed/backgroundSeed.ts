    ...
    const backgrounds: Prisma.BackgroundCreateInput[] = [
        ...
        },
        {
            ...
            items: [
                ...
                { name: 'зм', quantity: 15 }            ],
            specialAbilityName: 'Злочинний Контакт',
            description: 'У тебе є надійний і довірений контакт, який діє як звʼязковий у мережі інших злочинців та інформаторів. Ти знаєш, як отримувати і передавати повідомлення навіть на великі відстані; конкретно, ти знаєш місцеві канали передачі повідомлень у і з таких місць, а також знаєш інших, хто може передати твоє повідомлення в те місце, де воно потрібне.'
        },
        {
        ...
        },
        {
            ...
            description: 'У тебе чудова памʼять на карти та географію, і ти завжди можеш згадати загальну схему місцевості, поселень та інших особливостей навколо тебе. Крім того, ти можеш знайти їжу та прісну воду для себе та до пʼяти інших людей щодня, за умови, що земля пропонує ягоди, невелику дичину, воду тощо.'
        },
        {
        ...
        },
        {
            ...
            items: [
                ...
                { name: 'Значок на памʼять від батьків', quantity: 1 },
                { name: 'Звичайний одяг', quantity: 1 },
                { name: 'зм', quantity: 10 }],
        ...
        },
        {
            ...
            languagesToChooseCount: 1,
            items: [
                { name: 'Деревʼяний футляр з картою руїн', quantity: 1 },
        ...
        },
        {
            ...
            description: 'Ти знаєш багато впливових людей у Глибоких Водах і можеш отримати доступ до вищого суспільства міста. Люди схильні думати найкраще про тебе завдяки твоєму знатному походженню. Твої звʼязки з могутніми родинами Глибоких Вод відкривають тобі багато дверей.'
        },
        {
        ...
        },
        {
            ...
            description: 'Ти можеш розраховувати на допомогу інших членів Легіону Борос. Вони надають тобі їжу, житло та підтримку в бою, якщо це не суперечить їхньому обовʼязку. Твоя відданість справедливості та порядку визнається іншими легіонерами.'
        },
        {
        ...
        },
        {
            ...
            specialAbilityName: 'Зобовʼязання Оржова',
            description: 'Ти можеш використовувати свої звʼязки з Синдикатом Оржов для отримання позик, юридичної підтримки або тиску на боржників. Твоя влада ґрунтується на боргових зобовʼязаннях та релігійному авторитеті. Багато людей боргують Синдикату, і ти можеш використовувати це.'
        },
        {
        ...
        },
        {
            ...
            description: 'Ти маєш доступ до спільнот Конклаву Селесніі, де можеш отримати їжу, житло та підтримку від членів громади. Вони розглядають тебе як частину великої сімʼї. Твоя віра в єдність та гармонію резонує з філософією Конклаву.'
        },
        {
        ...
        },
        {
            ...
            description: 'Ти створив персону, яка приховує твою справжню ідентичність. У тебе є костюм та маскування, які дозволяють тобі приховувати свою справжню особу. Люди не можуть зʼєднати твої дві ідентичності, якщо ти не розкриваєш себе. Ця подвійність дає тобі свободу діяти.'
        },
        {
        ...
        },
        {
            ...
            specialAbilityName: 'Вилучена Памʼять',
            description: 'Твій час у Фейвайлді залишив тебе зі звʼязком з цим планом. Фейські істоти визнають, що ти був у їхньому світі, і можуть ставитися до тебе по-різному - деякі з цікавістю, інші з підозрою. Твій досвід у Фейвайлді змінив тебе незворотно.'
        },
        {
        ...
        },
        {
            ...
            description: 'Твої подорожі диким простором дали тобі знання про різні світи та космічні явища. Інші космічні мандрівники визнають тебе як досвідченого подорожнього та можуть поділитися інформацією.\n\n**Адаптація до Дикого Простору (Wildspace Adaptation):** Ви отримуєте рису «Здоровань». Крім того, ви навчилися пристосовуватися до нульової гравітації. Перебування в невагомості не дає вам <a href="/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage">перешкоди</a> на кидки атак ближнього бою.',
            gainsFeats: {
        ...
        },
        {
            ...
            description: 'Твій час у карнавалі Відьомського Світла дав тобі особливе відчуття магії та дива. Ти можеш розпізнати ілюзії та фейську магію легше за інших, і фейські істоти можуть реагувати на тебе інакше через твій звʼязок з карнавалом.'
        },
        {
            ...
            description: 'Як лицар Соламнії, ти звʼязаний клятвою честі та маєш повагу серед тих, хто знає про лицарів. Інші лицарі та ті, хто поважає закон, надають тобі допомогу та підтримку. Твоя відданість честі та справедливості визначає твої дії.',
            gainsFeats: {
        ...
        },
        {
            ...
            description: 'У тебе є мережа контактів у кримінальному світі. Ти знаєш, як отримувати інформацію, передавати повідомлення та знаходити безпечні будинки в містах, які ти відвідуєш. Твої звʼязки з підземним світом дають тобі доступ до ресурсів поза законом.'
        },
        {
