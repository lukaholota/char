...
- Ви маєте перевагу на ряткидки Статури, які ви робите для підтримки концентрації на заклинанні, коли отримуєте шкоду.
...
- Збільште ваш показник Статури на 1, до максимуму 20.
- Коли ви використовуєте дію Ухиляння у бою, ви можете витратити один Кубик Здоровʼя, щоб полікувати себе. Киньте кубик, додайте модифікатор Статури та відновіть відповідну кількість хіт-поїнтів (мінімум 1).`,
...
- Замість однієї з ваших атак дією Атака, ви можете випустити вибух полумʼя. Кожна істота за вашим вибором у межах 15 фт від вас повинна зробити ряткидок Спритності (СК = 8 + ваш бонус майстерності + модифікатор обраної характеристики) або отримати шкоду вогнем та стати засліпленою до кінця вашого наступного ходу. Кількість використань дорівнює вашому бонусу майстерності.`,
...
- Коли істота в межах 10 фт від вас завдає вам шкоди, ви можете використати свою реакцію, щоб змусити її зробити ряткидок Статури або отримати шкоду холодом та зменшити швидкість до 0 до кінця її наступного ходу. Кількість використань дорівнює вашому бонусу майстерності.`,
    prerequisiteFeat: "Strike of the Giants",
    grantedASI: { STR_OR_CON_OR_CHA: 1 },
  },
  {
