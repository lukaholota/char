...
export const seedClassFeatures = async ( prisma: PrismaClient ) => {
    ...
    const features: SeedFeatureCreateInput[] = [
        ...
        // Sorcerer Metamagic options
        {
            ...
            description: 'Коли ви накладаєте заклинання, що вимагає від інших істот у зоні ефекту робити ряткидок, ви можете витратити 1 очко магії, щоб обрати кількість істот, що не перевищує ваш модифікатор Харизми (мінімум одну). Обрані істоти автоматично успішно проходять рятівні кидки.',
