...
export const seedClassFeatures = async ( prisma: PrismaClient ) => {
    ...
    const features: Prisma.FeatureCreateInput[] = [
        ...
        },
        {
            ...
            engName: 'Extra Attack',
            description: 'Починаючи з 5 рівня, ви можете атакувати двічі замість одного разу, коли ви виконуєте дію Атака у свій хід. Кількість атак збільшується до трьох, коли ви досягаєте 11 рівня в цьому класі, і до чотирьох, коли ви досягаєте 20 рівня в цьому класі.',
            shortDescription: '2 атаки за дію (3 на 11 рівні, 4 на 20 рівні)',
            displayType: [FeatureDisplayType.PASSIVE],
        },
        {
            name: 'Незламний',
        ...
        // 1 РІВЕНЬ
        {
            ...
            description: 'Поки ви не носите жодної броні і не тримаєте щит, ваш Клас Броні дорівнює 10 + ваш модифікатор Спритності + ваш модифікатор Мудрості.',
            shortDescription: 'КБ = 10 + СПР + МДР без броні та щита',
            displayType: [FeatureDisplayType.PASSIVE],
            modifiesAC: {
                base: 10,
                bonus: {
        ...
        },
        {
            ...
            description: 'На 4 рівні ви можете дією витратити 2 очки кі і кинути кістку Бойових Мистецтв. Ви відновлюєте кількість хіт-поінтів, що дорівнює випавшому числу плюс ваш бонус майстерності.',
            shortDescription: '2 кі → відновити ХП = кістка Бойових Мистецтв + бонус майстерності',
        ...
        // 1 РІВЕНЬ
        {
            name: 'Експертиза',
            engName: 'Expertise',
            description: 'На 1 рівні виберіть дві з ваших навичок, або одну з ваших навичок та ваше Володіння інструментами злодія. Ваш бонус майстерності подвоюється для будь-якої перевірки характеристики, яку ви робите, використовуючи будь-яку з обраних характеристик.\n\nНа 6 рівні ви можете вибрати ще два з ваших Володінь (навичками або інструментами злодія), щоб отримати цю перевагу.',
            shortDescription: 'Подвійний бонус майстерності в 2 навичках (ще +2 на 6 рівні)',
            displayType: [FeatureDisplayType.PASSIVE],
            skillExpertises: {
                chooseFromCurrentProficiencies: true,
                count: 2
        ...
        // 2 РІВЕНЬ
        {
            ...
            description: 'Починаючи з 2 рівня, ваше швидке мислення та спритність дозволяють вам рухатися і діяти швидко. Ви можете використовувати бонусною дією дії Ривок [Dash], Відступ [Disengage] або Сховатися [Hide].',
        ...
        // 7 РІВЕНЬ
        {
            name: 'Ухилення',
            engName: 'Evasion',
            description: 'Починаючи з 7 рівня, ви можете спритно ухилятися від певних ефектів по площі (АОЕ), таких як вогняне дихання червоного дракона або заклинання Крижана буря [Ice Storm]. Коли ви піддаєтеся ефекту, який дозволяє вам зробити ряткидок Спритності, щоб отримати тільки половину шкоди, ви замість цього не отримуєте шкоди, якщо ви успішно пройшли ряткидок, і отримуєте тільки половину шкоди, якщо ви провалили його.',
            shortDescription: 'При успішному ряткидку на СПР замість половини шкоди - 0, при провалі - половина',
            displayType: [FeatureDisplayType.PASSIVE],
        },
        ...
        // 11 РІВЕНЬ
        {
            ...
            description: 'До 11 рівня ви відточили свої обрані навички до такої міри, що вони наближаються до досконалості. Щоразу, коли ви робите перевірку характеристики, що дозволяє вам додати ваш бонус майстерності, ви можете розглядати результат к20 9 або нижче як 10.',
            shortDescription: 'У перевірках з майстерністю к20 < 10 = 10 (мінімум 10 на дайсі)',
            displayType: [FeatureDisplayType.PASSIVE],
        },
        ...
        // 15 РІВЕНЬ
        {
            ...
            description: 'До 15 рівня ви набули більшої ментальної сили. Ви отримуєте майстерність у ряткидках Мудрості.',
            shortDescription: 'Майстерність у ряткидках Мудрості',
            displayType: [FeatureDisplayType.PASSIVE],
        ...
        // 3 РІВЕНЬ
        {
            name: 'Дар пакту',
            engName: 'Pact Boon',
            description: 'На 3 рівні ваш потойбічний патрон дарує вам подарунок за вашу вірну службу. Ви отримуєте одну з наступних здібностей на ваш вибір:\n\n**Пакт клинка (Pact of the Blade):** Ви можете дією створити пактову зброю у своїй порожній руці. Ви можете вибрати форму, яку приймає ця рукопашна зброя щоразу, коли ви її створюєте. Ви маєте майстерність з нею, поки тримаєте її. Ця зброя зникає, якщо вона знаходиться більше ніж за 5 футів від вас протягом 1 хвилини або більше. Вона також зникає, якщо ви використовуєте цю здібність знову, якщо ви відпускаєте зброю (без дії) або якщо ви помираєте.\n\n**Пакт ланцюга (Pact of the Chain):** Ви вивчаєте заклинання Find Familiar і можете накласти його як ритуал. Заклинання не зараховується до вашої кількості відомих заклинань. Коли ви накладаєте це заклинання, ви можете вибрати одну з нормальних форм для вашого фамільяра або одну з наступних спеціальних форм: Imp, Pseudodragon, Quasit або Sprite.\n\n**Пакт гримуара (Pact of the Tome):** Ваш патрон дає вам гримуар, який називається Книга Тіней. Коли ви отримуєте цю здібність, виберіть три замовляння зі списку заклинань будь-якого класу (три замовляння не обов\'язково мають бути з одного списку). Поки книга з вами, ви можете накладати ці замовляння необмежено. Вони не зараховуються до вашої кількості відомих замовлянь. Якщо вони не з\'являються у списку заклинань чорнокнижника, вони все одно є заклинаннями чорнокнижника для вас.\n\n**Пакт талісмана (Pact of the Talisman)** *(Tasha\'s)*: Ваш патрон дає вам амулет - талісман, який може допомогти носієві, коли потреба велика. Коли носій зазнає невдачі на перевірці характеристики, він може додати к4 до кидка, потенційно перетворюючи невдачу на успіх. Ця користь може бути використана кількість разів, що дорівнює вашому бонусу майстерності, і всі витрачені використання відновлюються, коли ви завершуєте тривалий відпочинок.',
...

        {
            ...
            description: 'Ви вивчаєте заклинання Пошук фамільяра [Find Familiar] і можете накласти його як ритуал. Заклинання не зараховується до вашої кількості відомих заклинань.\n\nКоли ви накладаєте це заклинання, ви можете вибрати одну з нормальних форм для вашого фамільяра або одну з наступних спеціальних форм: imp (бісик), pseudodragon (псевдодракон), quasit (квазіт) або sprite (спрайт).\n\nКрім того, коли ви виконуєте дію Атака, ви можете відмовитися від однієї зі своїх власних атак, щоб дозволити вашому фамільяру зробити одну атаку своєю реакцією.',
            shortDescription: 'Отримай Пошук фамільяра [Find Familiar] з особливими формами фамільярів, можеш наказати йому атакувати',
            displayType: [FeatureDisplayType.PASSIVE],
            givesSpells: {
        ...
        // 1. Agonizing Blast
        {
            ...
            description: 'Коли ви накладаєте Позамежний заряд [Eldritch Blast], додайте свій модифікатор Харизми до шкоди, яку він завдає при влученні.',
        ...
        // 2. Armor of Shadows
        {
            ...
            description: 'Ви можете накладати Обладунок мага [Mage Armor] на себе необмежено, не витрачаючи слот заклинань і без матеріальних компонентів.',
            shortDescription: 'Обладунок мага [Mage Armor] необмежено без слотів',
            displayType: [FeatureDisplayType.PASSIVE],
            givesSpells: {
        ...
        // 3. Ascendant Step
        {
            ...
            description: 'Ви можете накладати Левітація [Levitate] на себе необмежено, не витрачаючи слот заклинань і без матеріальних компонентів.',
        ...
        // 5. Beast Speech
        {
            ...
            description: 'Ви можете накладати Розмова з тваринами [Speak with Animals] необмежено, не витрачаючи слот заклинань.',
        ...
        // 7. Eldritch Sight
        {
            ...
            description: 'Ви можете накладати Виявлення магії [Detect Magic] необмежено, не витрачаючи слот заклинань.',
            shortDescription: 'Виявлення магії [Detect Magic] необмежено',
            displayType: [FeatureDisplayType.PASSIVE, FeatureDisplayType.ACTION],
            givesSpells: {
        ...
        // 9. Eldritch Spear
        {
            ...
            description: 'Коли ви накладаєте Позамежний заряд [Eldritch Blast], його радіус дії становить 300 футів.',
            shortDescription: 'Дальність Позамежного заряду [Eldritch Blast] = 300 футів',
            displayType: [FeatureDisplayType.PASSIVE],
        },
        ...
        // 12. Mask of Many Faces
        {
            ...
            description: 'Ви можете накладати Маскування [Disguise Self] необмежено, не витрачаючи слот заклинань.',
            shortDescription: 'Маскування [Disguise Self] необмежено',
            displayType: [FeatureDisplayType.PASSIVE, FeatureDisplayType.ACTION],
            givesSpells: {
        ...
        // 13. Misty Visions
        {
            ...
            description: 'Ви можете накладати Мовчазний образ [Silent Image] необмежено, не витрачаючи слот заклинань і без матеріальних компонентів.',
            shortDescription: 'Мовчазний образ [Silent Image] необмежено',
            displayType: [FeatureDisplayType.PASSIVE, FeatureDisplayType.ACTION],
            givesSpells: {
        ...
        // 14. Repelling Blast
        {
            ...
            description: 'Коли ви влучаєте по істоті Позамежним зарядом [Eldritch Blast], ви можете відштовхнути цю істоту на 10 футів від себе по прямій лінії.',
            shortDescription: 'Позамежний заряд [Eldritch Blast] відштовхує на 10 футів',
            displayType: [FeatureDisplayType.PASSIVE],
        },
        ...
        // 15. Sculptor of Flesh
        {
            ...
            description: 'Ви можете накласти Перевтілення [Polymorph] один раз, використовуючи слот заклинань чорнокнижника. Ви не можете зробити це знову, поки не завершите тривалий відпочинок.',
            shortDescription: 'Перевтілення [Polymorph] 1 раз на день',
        ...
        // 16. Sign of Ill Omen
        {
            ...
            description: 'Ви можете накласти Наділити прокляттям [Bestow Curse] один раз, використовуючи слот заклинань чорнокнижника. Ви не можете зробити це знову, поки не завершите тривалий відпочинок.',
            shortDescription: 'Наділити прокляттям [Bestow Curse] 1 раз на день',
            displayType: [FeatureDisplayType.RESOURCE, FeatureDisplayType.ACTION],
            limitedUsesPer: RestType.LONG_REST,
            usesCount: 1,
            givesSpells: {
        ...
        // 18. Visions of Distant Realms
        {
            ...
            description: 'Ви можете накладати Арканне око [Arcane Eye] необмежено, не витрачаючи слот заклинань.',
            shortDescription: 'Арканне око [Arcane Eye] необмежено',
            displayType: [FeatureDisplayType.PASSIVE, FeatureDisplayType.ACTION],
            givesSpells: {
        ...
        // 20. Whispers of the Grave
        {
            ...
            description: 'Ви можете накладати Розмова з мертвими [Speak with Dead] необмежено, не витрачаючи слот заклинань.',
            shortDescription: 'Розмова з мертвими [Speak with Dead] необмежено',
            displayType: [FeatureDisplayType.PASSIVE, FeatureDisplayType.ACTION],
            givesSpells: {
        ...
        // 22. Otherworldly Leap
        {
            ...
            description: 'Ви можете накладати Стрибок [Jump] на себе необмежено, не витрачаючи слот заклинань і без матеріальних компонентів.',
            shortDescription: 'Стрибок [Jump] необмежено на себе',
            displayType: [FeatureDisplayType.PASSIVE, FeatureDisplayType.ACTION],
            givesSpells: {
        ...
        // 23. Gift of the Depths
        {
            ...
            description: 'Ви можете дихати під водою, і ви отримуєте швидкість плавання, що дорівнює вашій швидкості ходьби.\n\nВи також можете накладати Дихання водою [Water Breathing] один раз, не витрачаючи слот заклинань. Ви відновлюєте можливість зробити це знову, коли завершуєте тривалий відпочинок.',
            shortDescription: 'Дихання під водою + швидкість плавання, Дихання водою [Water Breathing] 1/день',
            displayType: [FeatureDisplayType.PASSIVE, FeatureDisplayType.ACTION],
            limitedUsesPer: RestType.LONG_REST,
            usesCount: 1,
            givesSpells: {
        ...
        // 25. Grasp of Hadar
        {
            ...
            description: 'Один раз за кожен ваш хід, коли ви влучаєте по істоті Позамежним зарядом [Eldritch Blast], ви можете перемістити цю істоту по прямій лінії на 10 футів ближче до вас.',
            shortDescription: 'Позамежний заряд [Eldritch Blast] підтягує на 10 футів (1 раз за хід)',
            displayType: [FeatureDisplayType.PASSIVE],
        },
        ...
        // 26. Lance of Lethargy
        {
            ...
            description: 'Один раз за кожен ваш хід, коли ви влучаєте по істоті Позамежним зарядом [Eldritch Blast], ви можете зменшити швидкість цієї істоти на 10 футів до кінця вашого наступного ходу.',
            shortDescription: 'Позамежний заряд [Eldritch Blast] сповільнює на 10 футів (1 раз за хід)',
            displayType: [FeatureDisplayType.PASSIVE],
        },
        ...
        // 27. Fiendish Vigor
        {
            ...
            description: 'Ви можете накладати Удаване життя [False Life] на себе необмежено як заклинання 1 рівня, не витрачаючи слот заклинань і без матеріальних компонентів.',
            shortDescription: 'Удаване життя [False Life] необмежено на себе',
            displayType: [FeatureDisplayType.PASSIVE],
            givesSpells: {
        ...
        // 30. Shrouded in Shadow
        {
            ...
            description: 'Ви можете накладати Невидимість [Invisibility] на себе необмежено, не витрачаючи слот заклинань і без матеріальних компонентів.',
            shortDescription: 'Невидимість [Invisibility] необмежено на себе',
            displayType: [FeatureDisplayType.PASSIVE, FeatureDisplayType.ACTION],
            givesSpells: {
        ...
        // 31. Master of Myriad Forms
        {
            ...
            description: 'Ви можете накладати Зміна вигляду [Alter Self] необмежено, не витрачаючи слот заклинань.',
            shortDescription: 'Зміна вигляду [Alter Self] необмежено',
            displayType: [FeatureDisplayType.PASSIVE, FeatureDisplayType.ACTION],
            givesSpells: {
        ...
        // 35. Minions of Chaos
        {
            ...
            description: 'Ви можете накласти З\'ява стихійника [Conjure Elemental] один раз, використовуючи слот заклинань чорнокнижника. Ви не можете зробити це знову, поки не завершите тривалий відпочинок.',
            shortDescription: 'З\'ява стихійника [Conjure Elemental] 1 раз на день',
            displayType: [FeatureDisplayType.PASSIVE, FeatureDisplayType.ACTION],
            limitedUsesPer: RestType.LONG_REST,
            usesCount: 1,
            givesSpells: {
        ...
        // 37. Chains of Carceri
        {
            ...
            description: 'Ви можете накладати Стримування монстра [Hold Monster] необмежено - націлюючись на небожителів, нечисть або елементалів - не витрачаючи слот заклинань і без матеріальних компонентів. Ви повинні завершити тривалий відпочинок, перш ніж зможете використати цей виклик на тій самій істоті знову.',
            shortDescription: 'Стримування монстра [Hold Monster] необмежено на небожителів/нечисть/елементалів',
            displayType: [FeatureDisplayType.PASSIVE, FeatureDisplayType.ACTION],
            givesSpells: {
        ...
        // 39. Trickster's Escape
        {
            ...
            description: 'Ви можете накласти Свобода рухів [Freedom of Movement] на себе один раз, не витрачаючи слот заклинань. Ви відновлюєте можливість зробити це знову, коли завершуєте тривалий відпочинок.',
            shortDescription: 'Свобода рухів [Freedom of Movement] на себе 1 раз на день',
            displayType: [FeatureDisplayType.PASSIVE, FeatureDisplayType.ACTION],
            limitedUsesPer: RestType.LONG_REST,
            usesCount: 1,
            givesSpells: {
        ...
        // 40. Bewitching Whispers
        {
            ...
            description: 'Ви можете накласти Примус [Compulsion] один раз, використовуючи слот заклинань чорнокнижника. Ви не можете зробити це знову, поки не завершите тривалий відпочинок.',
            shortDescription: 'Примус [Compulsion] 1 раз на день',
            displayType: [FeatureDisplayType.PASSIVE, FeatureDisplayType.ACTION],
            limitedUsesPer: RestType.LONG_REST,
            usesCount: 1,
            givesSpells: {
        ...
        // 41. Dreadful Word
        {
            ...
            description: 'Ви можете накласти Сум\'яття [Confusion] один раз, використовуючи слот заклинань чорнокнижника. Ви не можете зробити це знову, поки не завершите тривалий відпочинок.',
            shortDescription: 'Сум\'яття [Confusion] 1 раз на день',
            displayType: [FeatureDisplayType.PASSIVE, FeatureDisplayType.ACTION],
            limitedUsesPer: RestType.LONG_REST,
            usesCount: 1,
            givesSpells: {
        ...
        // 42. Mire the Mind
        {
            ...
            description: 'Ви можете накласти Уповільнення [Slow] один раз, використовуючи слот заклинань чорнокнижника. Ви не можете зробити це знову, поки не завершите тривалий відпочинок.',
            shortDescription: 'Уповільнення [Slow] 1 раз на день',
            displayType: [FeatureDisplayType.PASSIVE, FeatureDisplayType.ACTION],
            limitedUsesPer: RestType.LONG_REST,
            usesCount: 1,
            givesSpells: {
        ...
        // 43. Thief of Five Fates
        {
            ...
            description: 'Ви можете накласти Зурочення [Bane] один раз, використовуючи слот заклинань чорнокнижника. Ви не можете зробити це знову, поки не завершите тривалий відпочинок.',
            shortDescription: 'Зурочення [Bane] 1 раз на день',
            displayType: [FeatureDisplayType.PASSIVE, FeatureDisplayType.ACTION],
            limitedUsesPer: RestType.LONG_REST,
            usesCount: 1,
            givesSpells: {
        ...
        // 52. Undying Servitude
        {
            ...
            description: 'Ви можете накласти Оживлення мерців [Animate Dead] один раз, не витрачаючи слот заклинань. Ви відновлюєте можливість зробити це знову, коли завершуєте тривалий відпочинок.',
            shortDescription: 'Оживлення мерців [Animate Dead] 1 раз на день',
            displayType: [FeatureDisplayType.PASSIVE, FeatureDisplayType.ACTION],
            limitedUsesPer: RestType.LONG_REST,
            usesCount: 1,
            givesSpells: {
        ...
        // 53. Rebuke of the Talisman
        {
            ...
            description: 'Коли носій вашого талісмана отримує шкоду від істоти, яку ви можете бачити в межах 30 футів від вас, ви можете реакцією завдати психічної шкоди атакуючому, що дорівнює вашому бонусу майстерності, і відштовхнути його на відстань до 10 футів від носія талісмана.',
        ...
        // 54. Protection of the Talisman
        {
            ...
            description: 'Коли носій вашого талісмана зазнає невдачі на ряткидку, він може додати к4 до кидка, потенційно перетворюючи невдачу на успіх. Ця користь може бути використана кількість разів, що дорівнює вашому бонусу майстерності, і всі витрачені використання відновлюються, коли носій завершує тривалий відпочинок.',
            shortDescription: '+к4 до проваленого ряткидку (кіл. використань = бонус майстерності)',
            displayType: [FeatureDisplayType.PASSIVE],
            limitedUsesPer: RestType.LONG_REST,
            usesCountDependsOnProficiencyBonus: true,
        },
        ...
        // Sorcerer optional features
        {
            ...
            shortDescription: 'Витратьте 1 очко магії, щоб перебросити перевірку',
            displayType: [FeatureDisplayType.PASSIVE],
        },
        {
            name: 'Гнучкість чарівника',
        ...
        // Sorcerer Metamagic options
        {
            ...
            description: 'Коли ви накладаєте заклинання, що вимагає від інших істот у зоні ефекту робити ряткидок, ви можете витратити 1 очко магії, щоб обрати кілька цих істот до свого модифікатора Харизми (мінімум одну). Обрані істоти автоматично проходять ряткидок.',
        ...
        },
        {
            ...
            description: 'Коли ви кидаєте кубики шкоди для заклинання, ви можете витратити 1 очко магії, щоб перебросити кілька кубиків до значення вашого модифікатора Харизми (мінімум один). Ви повинні використати нові результати. Ви можете застосувати цю опцію навіть якщо вже використали іншу метамагію.',
            shortDescription: 'Перебросьте кубики шкоди до модифікатора Харизми',
            displayType: [FeatureDisplayType.PASSIVE],
        },
        {
        ...
        },
        {
            ...
            description: 'Коли ви накладаєте заклинання з тривалістю накладання дією, ви можете витратити 2 очки магії, щоб змінити тривалість накладання на бонусну дію.',
