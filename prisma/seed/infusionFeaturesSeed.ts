...
const INFUSION_FEATURE_SEED_INPUTS: SeedFeatureCreateInput[] = [
		{
			...
			description: 'Тримаючи цей предмет, істота отримує **+1** до кидків атак заклять. Крім того, істота ігнорує <a href="/rules/combat#making-an-attack--cover">половинне укриття</a> при здійсненні атаки закляттям. Бонус збільшується до **+2** на 10-му рівні цього класу.',
		...
		},
		{
			...
			description: 'Ця магічна зброя надає **+1** до кидків атаки та шкоди. Тримаючи її, той, хто нею користується, може здійснити <a href="/rules/combat#order-of-combat--bonus-actions">бонусну дію</a>, щоб вона випромінювала яскраве світло на відстань 30 футів та тьмяне світло на додаткові 30 футів. Той, хто нею користується, може гасити світло бонусною дією.\n\nЗброя має 4 заряди. <a href="/rules/combat#reactions--reactions">Реакцією</a> одразу після того, як бути вражений атакою, той, хто нею користується, може витратити 1 заряд, щоб ослепити нападника до кінця його наступного ходу, якщо нападник провалить рятувальний кидок Статури проти СК рятування вашого заклинання. Зброя отримує 1к4 витрачених зарядів щодня на світанку.',
		...
		},
		{
			...
			description: 'Цей предмет може надати поштовх носієві, щоб перекопцентрувати його розум. Предмет має 4 заряди. Коли носій провалює рятувальний кидок Статури, щоб підтримати <a href="/rules/spellcasting#concentration-rules">концентрацію</a> на закляттях, носій може використати свою <a href="/rules/combat#reactions--reactions">реакцію</a>, щоб витратити 1 заряд предмета, щоб замість цього успішно пройти. Предмет отримує 1к4 витрачених зарядів щодня на світанку.',
		...
		},
		{
			...
			description: 'Під час носіння цих чобіт істота може телепортуватися до 15 футів як <a href="/rules/combat#order-of-combat--bonus-actions">бонусну дію</a> в незайнятий простір, який вона може бачити. Істота повинна займати цей простір в якийсь момент упродовж поточного ходу.',
		...
		},
		{
			...
			description: 'Під час носіння цього шолома істота отримує <a href="/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage">перевагу</a> на кидки ініціативи. Крім того, носій не може бути застигнутий зненацька, за умови, що він не <a href="/rules/conditions#condition-incapacitated">недієздатний</a>.',
