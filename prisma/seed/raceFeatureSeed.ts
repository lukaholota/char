...
export const seedRaceFeatures = async (prisma: PrismaClient) => {
  ...
  const features: SeedFeatureCreateInput[] = [
    ...
    // ============ ВРОДЖЕННА МАГІЯ (ТИФЛІНГИ) ============
    {
      ...
      shortDescription:
        "<a href=\"/spells/thaumaturgy\">Дивотворство [Thaumaturgy]</a>, <a href=\"/spells/hellish-rebuke\">Пекельна відсіч [Hellish Rebuke]</a>, Темрява [Darkness]",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      givesSpells: {
        connect: [
    ...
    // ============ DEEP GNOME ============
    {
      ...
      description:
        "Ви маєте перевагу на перевірки Спритності (Непомітність), щоб сховатися в камʼяному середовищі.",
    ...
    },
    {
      ...
      shortDescription:
        "<a href=\"/spells/mage-hand\">Магічна рука [Mage Hand]</a>, Щит [Shield], <a href=\"/spells/detect-thoughts\">Виявлення думок [Detect Thoughts]</a>",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      givesSpells: {
        connect: [
    ...
    // ASTRAL ELF
    {
      ...
      engName: "Astral Fire",
      description:
        "Ви знаєте один з наступних замовлянь на вибір: <a href=\"/spells/dancing-lights\">Мерехтливі вогники [Dancing Lights]</a>, Світло [Light] або <a href=\"/spells/sacred-flame\">Священне полумʼя [Sacred Flame]</a>. Характеристика закляття - Інтелект, Мудрість або Харизма (на ваш вибір при виборі раси).",
      shortDescription:
        "1 замовляння: <a href=\"/spells/dancing-lights\">Мерехтливі вогники [Dancing Lights]</a>/Світло [Light]/<a href=\"/spells/sacred-flame\">Священне полумʼя [Sacred Flame]</a>",
      displayType: [FeatureDisplayType.PASSIVE],
    ...
    // HADOZEE
    {
      ...
      description:
        "Бонусною дією ви можете використовувати ноги для маніпулювання обʼєктом, відкриття або закриття дверей чи контейнерів, підняття або встановлення крихітного обʼєкта.",
    ...
    },
    {
      ...
      description:
        "Звʼязок вашого розуму зі світом навколо вас зміцнює вашу волю. Ви маєте перевагу на всі ряткидки Мудрості та Харизми.",
    ...
    },
    {
      ...
      description:
        "Калаштари сплять, але вони не зʼєднуються з планом снів, як це роблять інші істоти. Замість цього їхні розуми черпають зі спогадів їхнього потойбічного духа під час сну. Таким чином, ви імунні до магічних заклинань та ефектів, що вимагають від вас бачити сни, як-от заклинання <a href=\"/spells/dream\">Сновидіння [Dream]</a>, але не до заклинань та ефектів, що присипляють вас, як-от заклинання Сон [Sleep].",
    ...
    },
    {
      ...
      description:
        'Ви знаєте замовляння <a href="/spell/1344">Повідомлення [Message]</a>. Ви також можете використовувати заклинання <a href="/spell/1315">Розуміння мов [Comprehend Languages]</a> по одному разу за допомогою цієї риси. Починаючи з 3-го рівня, ви також можете використовувати заклинання <a href="/spell/1282">Магічні вуста [Magic Mouth]</a> по одному разу за допомогою цієї риси. Після того, як ви використали Розуміння мов [Comprehend Languages] або Магічні вуста [Magic Mouth] за допомогою цієї риси, ви не можете використовувати це заклинання знову, доки не завершите довгий відпочинок. Інтелект є вашою заклинальною характеристикою для цих заклинань.',
    ...
    },
    {
      ...
      shortDescription: "Щит [Shield] та <a href=\"/spells/warding-bond\">Охоронний звʼязок [Warding Bond]</a> 1 раз на день",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      usesCount: 1,
    },
