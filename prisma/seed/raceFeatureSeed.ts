...
const RACE_FEATURE_SEED_INPUTS: SeedFeatureCreateInput[] = [
    // ============ СЕНСИ І ПЕРЦЕПЦІЯ ============
    {
      name: "Темнозір",
      engName: "Darkvision",
    ...
    // ============ ФЕЙ/МАГІЧНА СТІЙКІСТЬ ============
    {
      ...
      description:
        "Ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> при ряткидках проти зачарування, і вас неможливо магічно приспати.",
      shortDescription:
    ...
    },
    {
      ...
      description:
        "Ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на ряткидки Інтелекту, Мудрості та Харизми проти магії.",
    ...
    },
    {
      ...
      description: "Ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на ряткидки проти страху та отрути.",
    ...
    },
    {
      name: "Хоробрість",
      engName: "Brave",
      description: "Ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на ряткидки проти страху.",
...

    {
      ...
      description:
        "Ви маєте опір до типу шкоди, повʼязаного з вашим драконячим родоводом.",
    ...
    // ============ ВРОДЖЕННА МАГІЯ (ТИФЛІНГИ) ============
    {
      ...
      description:
        "Ви знаєте заклинання <a href=\"/spells/thaumaturgy\">Дивотворство [Thaumaturgy]</a>. Коли ви досягаєте 3-го рівня, ви можете один раз використати заклинання <a href=\"/spells/hellish-rebuke\">Пекельна відсіч [Hellish Rebuke]</a> як заклинання 2-го рівня. Коли ви досягаєте 5-го рівня, ви також можете один раз використати заклинання <a href=\"/spells/darkness\">Темрява [Darkness]</a>. Після використання Пекельної відсічі [Hellish Rebuke] або Темряви [Darkness] ви не можете використовувати це заклинання знову, доки не завершите довгий відпочинок. Ви також можете використовувати ці заклинання, використовуючи будь-які слоти заклинань відповідного рівня, які у вас є. Харизма є вашою характеристикою для цих заклинань, коли ви використовуєте їх цією здібністю.",
      shortDescription:
        "<a href=\"/spells/thaumaturgy\">Дивотворство [Thaumaturgy]</a>, <a href=\"/spells/hellish-rebuke\">Пекельна відсіч [Hellish Rebuke]</a>, <a href=\"/spells/darkness\">Темрява [Darkness]</a>",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      givesSpells: {
        connect: [
    ...
    // ============ ВРОДЖЕНІ ЗДІБНОСТІ ============
    {
      name: "Камʼяна витривалість",
      engName: "Dwarven Toughness (Dwarf Race)",
      description:
    ...
    },
    {
      ...
      description:
        "Ви маєте експертизу на перевірки Історії, що стосуються походження камʼяних споруд",
      shortDescription:
    ...
    },
    {
      ...
      engName: "Dwarven Armor Training (Dwarf Race)",
    ...
    // ============ AASIMAR ============
    {
      ...
      description:
        "Дією ви можете торкнутися істоти й відновити їй кількість здоровʼя, що дорівнює вашому Бонусу Майстерності. Після використання цієї здібності ви не можете використовувати її знову, доки не завершите довгий відпочинок.",
    ...
    },
    {
      ...
      description: "Ви знаєте замовляння <a href=\"/spells/light\">Світло [Light]</a>.",
      shortDescription: "замовляння <a href=\"/spells/light\">Світло [Light]</a>",
      displayType: [FeatureDisplayType.PASSIVE],
      givesSpells: {
    ...
    // ============ CENTAUR ============
    {
      ...
      engName: "Charge",
      description:
        "Якщо ви рухаєтесь принаймні на 30 футів прямо до цілі, а потім вражаєте її рукопашною атакою зброєю в той самий хід, ви можете негайно здійснити один додатковий удар копитами <a href=\"/rules/combat#order-of-combat--bonus-actions\">Бонусною дією</a>.",
    ...
    {
      name: "Перевертень",
      engName: "Shapechanger (Changeling)",
      description:
    ...
    // ============ DEEP GNOME ============
    {
      name: "Камʼяне маскування",
      engName: "Stone Camouflage (Deep Gnome Race)",
      description:
        "Ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на перевірки Спритності (Непомітність), щоб сховатися в камʼяному середовищі.",
    ...
    },
    {
      ...
      description:
        "Ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на ряткидки Інтелекту, Мудрості та Харизми проти заклинань.",
      shortDescription:
    ...
    },
    {
      ...
      description:
        "Коли ви робите перевірку Непомітності, ви можете зробити перевірку з <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагою</a>. Ви можете використовувати цю здібність кількість разів, що дорівнює вашому Бонусу Майстерності, і відновлюєте всі витрачені використання після завершення довгого відпочинку.",
      shortDescription:
    ...
    // ============ DUERGAR ============
    {
      ...
      engName: "Duergar Resilience (Duergar Race)",
      description:
        "Ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на ряткидки проти ілюзій та проти зачарування або паралічу.",
      shortDescription: "Перевага проти ілюзій, зачарування, паралічу",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    {
      name: "Магія дуергарів",
      engName: "Duergar Magic (Duergar Race)",
      description:
        "Коли ви досягаєте 3-го рівня, ви можете один раз використати заклинання <a href=\"/spells/enlarge-reduce\">Збільшення/Зменшення [Enlarge/Reduce]</a> на себе. Коли ви досягаєте 5-го рівня, ви також можете один раз використати заклинання <a href=\"/spells/invisibility\">Невидимість [Invisibility]</a> на себе. Після використання кожного з цих заклять ви не можете використовувати це заклинання знову, доки не завершите довгий відпочинок. Ви також можете використовувати ці заклинання, використовуючи будь-які слоти заклинань відповідного рівня, які у вас є. Інтелект, Мудрість або Харизма є вашою характеристикою для цих заклинань, коли ви використовуєте їх цією здібністю (ви обираєте при виборі цієї раси).",
      shortDescription:
        "<a href=\"/spells/enlarge-reduce\">Збільшення/Зменшення [Enlarge/Reduce]</a>, <a href=\"/spells/invisibility\">Невидимість [Invisibility]</a>",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      givesSpells: {
    ...
    },
    {
      ...
      description:
        "Ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на ряткидки, які ви робите, щоб уникнути або завершити стан зачарування або приголомшення на собі.",
    ...
    // ============ FAIRY ============
    {
      ...
      engName: "Fairy Magic",
      description:
        "Ви знаєте замовляння <a href=\"/spells/druidcraft\">Ремесло друїдів [Druidcraft]</a>. Коли ви досягаєте 3-го рівня, ви можете один раз використати заклинання <a href=\"/spells/faerie-fire\">Вогники фей [Faerie Fire]</a>. Коли ви досягаєте 5-го рівня, ви також можете один раз використати заклинання <a href=\"/spells/enlarge-reduce\">Збільшення/Зменшення [Enlarge/Reduce]</a>. Після використання Вогників фей [Faerie Fire] або <a href=\"/spells/enlarge-reduce\">Збільшення/Зменшення [Enlarge/Reduce]</a> ви не можете використовувати це заклинання знову, доки не завершите довгий відпочинок. Ви також можете використовувати ці заклинання, використовуючи будь-які слоти заклинань відповідного рівня, які у вас є. Інтелект, Мудрість або Харизма є вашою характеристикою для цих заклинань, коли ви використовуєте їх цією здібністю (ви обираєте при виборі цієї раси).",
      shortDescription:
        "<a href=\"/spells/druidcraft\">Ремесло друїдів [Druidcraft]</a>, <a href=\"/spells/faerie-fire\">Вогники фей [Faerie Fire]</a>, <a href=\"/spells/enlarge-reduce\">Збільшення/Зменшення [Enlarge/Reduce]</a>",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      givesSpells: {
        connect: [
    ...
    // ============ FIRBOLG ============
    {
      ...
      engName: "Hidden Step",
      description:
        "<a href=\"/rules/combat#order-of-combat--bonus-actions\">Бонусною дією</a> ви можете магічно стати <a href=\"/rules/conditions#condition-invisible\">невидимим</a> до початку вашого наступного ходу або до моменту, коли ви атакуєте, завдаєте шкоди або змушуєте когось зробити ряткидок. Після використання цієї здібності ви не можете використовувати її знову, доки не завершите короткий або довгий відпочинок.",
    ...
    },
    {
      ...
      description:
        "Ви можете один раз використати заклинання <a href=\"/spells/detect-magic\">Виявлення магії [Detect Magic]</a> та <a href=\"/spells/disguise-self\">Маскування [Disguise Self]</a>. Коли ви використовуєте цю версію <a href=\"/spells/disguise-self\">Маскування [Disguise Self]</a>, ви можете здаватися на 3 фути вищим або нижчим. Після використання кожного з цих заклять ви не можете використовувати це заклинання знову, доки не завершите довгий відпочинок. Ви також можете використовувати ці заклинання, використовуючи будь-які слоти заклинань, які у вас є. Інтелект, Мудрість або Харизма є вашою характеристикою для цих заклинань, коли ви використовуєте їх цією здібністю (ви обираєте при виборі цієї раси).",
      shortDescription:
        "<a href=\"/spells/detect-magic\">Виявлення магії [Detect Magic]</a>, <a href=\"/spells/disguise-self\">Маскування [Disguise Self]</a>",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      givesSpells: {
    ...
    },
    {
      ...
      description:
        "Ви маєте здатність спілкуватися в обмежений спосіб зі Звірами, Рослинами та рослинністю. Вони можуть розуміти значення ваших слів, хоча ви не маєте спеціальної здатності розуміти їх у відповідь. Ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на всі перевірки Харизми, які ви робите, щоб вплинути на них.",
      shortDescription:
    ...
    // ============ GENASI AIR ============
    {
      ...
      description:
        "Ви знаєте замовляння <a href=\"/spells/shocking-grasp\">Шокувальний дотик [Shocking Grasp]</a>. Коли ви досягаєте 3-го рівня, ви можете один раз використати заклинання <a href=\"/spells/feather-fall\">Падіння пірʼїною [Feather Fall]</a>. Коли ви досягаєте 5-го рівня, ви також можете один раз використати заклинання <a href=\"/spells/levitate\">Левітація [Levitate]</a> на себе. Після використання <a href=\"/spells/feather-fall\">Падіння пірʼїною [Feather Fall]</a> або Левітації [Levitate] ви не можете використовувати це заклинання знову, доки не завершите довгий відпочинок. Ви також можете використовувати ці заклинання, використовуючи будь-які слоти заклинань відповідного рівня, які у вас є. Інтелект, Мудрість або Харизма є вашою характеристикою для цих заклинань, коли ви використовуєте їх цією здібністю (ви обираєте при виборі цієї раси).",
      shortDescription:
        "<a href=\"/spells/shocking-grasp\">Шокувальний дотик [Shocking Grasp]</a>, <a href=\"/spells/feather-fall\">Падіння пірʼїною [Feather Fall]</a>, <a href=\"/spells/levitate\">Левітація [Levitate]</a>",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      givesSpells: {
        connect: [
    ...
    },
    {
      ...
      description:
        "Ви можете затримувати дихання нескінченно довго, поки ви не <a href=\"/rules/conditions#condition-incapacitated\">недієздатні</a>.",
    ...
    // ============ GENASI EARTH ============
    {
      ...
      description:
        "Ви знаєте замовляння <a href=\"/spells/blade-ward\">Захист від зброї [Blade Ward]</a>. Ви можете використовувати його основною дією, але також - бонусною кількість разів, що дорівнюють вашому Бонусу Майстерності, і ви відновлюєте кількість таких використань після довгого відпочинку. Коли ви досягаєте 5-го рівня, ви можете один раз використати заклинання <a href=\"/spells/pass-without-trace\">Переміщення без сліду [Pass without Trace]</a>. Після використання <a href=\"/spells/pass-without-trace\">Переміщення без сліду [Pass without Trace]</a> ви не можете використовувати це заклинання знову, доки не завершите довгий відпочинок. Ви також можете використовувати ці заклинання, використовуючи будь-які слоти заклинань відповідного рівня, які у вас є. Інтелект, Мудрість або Харизма є вашою характеристикою для цих заклинань, коли ви використовуєте їх цією здібністю (ви обираєте при виборі цієї раси).",
      shortDescription:
        "<a href=\"/spells/blade-ward\">Захист від зброї [Blade Ward]</a>, <a href=\"/spells/pass-without-trace\">Переміщення без сліду [Pass without Trace]</a>",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      usesCountDependsOnProficiencyBonus: true, // Додаємо ✅
      givesSpells: {
    ...
    // ============ GENASI FIRE ============
    {
      name: "Досягти полумʼя",
      engName: "Reach to the Blaze",
      description:
        "Ви знаєте замовляння <a href=\"/spells/produce-flame\">Створення вогню [Produce Flame]</a>. Коли ви досягаєте 3-го рівня, ви можете один раз використати заклинання <a href=\"/spells/burning-hands\">Палючі долоні [Burning Hands]</a> як заклинання 1-го рівня. Коли ви досягаєте 5-го рівня, ви також можете один раз використати заклинання Палаюча сфера [Flaming Sphere] як заклинання 2-го рівня. Після використання Палючих долонь [Burning Hands] або Палаючої сфери [Flaming Sphere] ви не можете використовувати це заклинання знову, доки не завершите довгий відпочинок. Ви також можете використовувати ці заклинання, використовуючи будь-які слоти заклинань відповідного рівня, які у вас є. Інтелект, Мудрість або Харизма є вашою характеристикою для цих заклинань, коли ви використовуєте їх цією здібністю (ви обираєте при виборі цієї раси).",
      shortDescription:
        "<a href=\"/spells/produce-flame\">Створення вогню [Produce Flame]</a>, <a href=\"/spells/burning-hands\">Палючі долоні [Burning Hands]</a>, Палаюча сфера [Flaming Sphere]",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      givesSpells: {
        connect: [
    ...
    // ============ GENASI WATER ============
    {
      ...
      description:
        "Ви знаєте замовляння <a href=\"/spells/shape-water\">Формування води [Shape Water]</a>. Коли ви досягаєте 3-го рівня, ви можете один раз використати заклинання <a href=\"/spells/create-or-destroy-water\">Створення чи знищення води [Create or Destroy Water]</a> як заклинання 1-го рівня. Коли ви досягаєте 5-го рівня, ви також можете один раз використати заклинання <a href=\"/spells/water-breathing\">Дихання водою [Water Breathing]</a>. Після використання <a href=\"/spells/create-or-destroy-water\">Створення чи знищення води [Create or Destroy Water]</a> або <a href=\"/spells/water-breathing\">Дихання водою [Water Breathing]</a> ви не можете використовувати це заклинання знову, доки не завершите довгий відпочинок. Ви також можете використовувати ці заклинання, використовуючи будь-які слоти заклинань відповідного рівня, які у вас є. Інтелект, Мудрість або Харизма є вашою характеристикою для цих заклинань, коли ви використовуєте їх цією здібністю (ви обираєте при виборі цієї раси).",
      shortDescription:
        "<a href=\"/spells/shape-water\">Формування води [Shape Water]</a>, <a href=\"/spells/create-or-destroy-water\">Створення чи знищення води [Create or Destroy Water]</a>, <a href=\"/spells/water-breathing\">Дихання водою [Water Breathing]</a>",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      givesSpells: {
        connect: [
    ...
    // ============ GITHYANKI ============
    {
      ...
      description:
        "Ви знаєте замовляння <a href=\"/spells/mage-hand\">Магічна рука [Mage Hand]</a>, і рука невидима, коли ви використовуєте це замовляння цією здібністю. Коли ви досягаєте 3-го рівня, ви можете використати заклинання <a href=\"/spells/jump\">Стрибок [Jump]</a> цією здібністю. Коли ви досягаєте 5-го рівня, ви також можете використати заклинання <a href=\"/spells/misty-step\">Туманний крок [Misty Step]</a> з нею. Після того, як ви використали <a href=\"/spells/jump\">Стрибок [Jump]</a> або <a href=\"/spells/misty-step\">Туманний крок [Misty Step]</a> цією здібністю, ви не можете використати це заклинання з нею знову, доки не завершите довгий відпочинок. Ви також можете використати будь-яке з цих заклинань, використовуючи будь-які слоти заклинань відповідного рівня, які у вас є. Інтелект, Мудрість або Харизма є вашою характеристикою для цих заклинань, коли ви використовуєте їх цією здібністю (ви обираєте при виборі цієї раси). Жодне з цих заклинань не вимагає компонентів заклинання, коли ви використовуєте їх цією здібністю.",
      shortDescription:
        "<a href=\"/spells/mage-hand\">Магічна рука [Mage Hand]</a>, <a href=\"/spells/jump\">Стрибок [Jump]</a>, <a href=\"/spells/misty-step\">Туманний крок [Misty Step]</a>",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      givesSpells: {
        connect: [
    ...
    // ============ GITHZERAI ============
    {
      ...
      description:
        "Ваші вроджені псіонічні здібності дають вам <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на ряткидки проти станів Зачарування та Переляку та ваші думки не можуть бути прочитані за допомогою телепатії, якщо ви не дозволите це.",
    ...
    },
    {
      ...
      description:
        "Ви знаєте замовляння <a href=\"/spells/mage-hand\">Магічна рука [Mage Hand]</a>, і рука невидима, коли ви використовуєте це замовляння цією здібністю. Коли ви досягаєте 3-го рівня, ви можете один раз використати заклинання <a href=\"/spells/shield\">Щит [Shield]</a>. Коли ви досягаєте 5-го рівня, ви також можете один раз використати заклинання <a href=\"/spells/detect-thoughts\">Виявлення думок [Detect Thoughts]</a>. Після використання Щита [Shield] або <a href=\"/spells/detect-thoughts\">Виявлення думок [Detect Thoughts]</a> ви не можете використовувати це заклинання знову, доки не завершите довгий відпочинок. Ви також можете використовувати ці заклинання, використовуючи будь-які слоти заклинань відповідного рівня, які у вас є. Інтелект, Мудрість або Харизма є вашою характеристикою для цих заклинань, коли ви використовуєте їх цією здібністю (ви обираєте при виборі цієї раси). Жодне з цих заклинань не вимагає компонентів заклинання, коли ви використовуєте їх цією здібністю.",
      shortDescription:
        "<a href=\"/spells/mage-hand\">Магічна рука [Mage Hand]</a>, <a href=\"/spells/shield\">Щит [Shield]</a>, <a href=\"/spells/detect-thoughts\">Виявлення думок [Detect Thoughts]</a>",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      givesSpells: {
        connect: [
    ...
    },
    {
      ...
      description:
        "Ви можете виконати <a href=\"/rules/combat#actions-in-combat--disengage\">дію Відступ</a> або Сховатися <a href=\"/rules/combat#order-of-combat--bonus-actions\">Бонусною дією</a> в кожен зі своїх ходів.",
    ...
    // ============ GOLIATH ============
    {
      ...
      description:
        "<a href=\"/rules/combat#reactions--reactions\">Реакцією</a>, коли ви отримуєте шкоду, ви можете зменшити цю шкоду на 1к12 + ваш модифікатор Статури. Кількість використань на довгий відпочинок = Бонус Майстерності.",
    ...
    },
    {
      ...
      description:
        "Коли ви провалюєте ряткидок Спритності, ви можете використати свою <a href=\"/rules/combat#reactions--reactions\">реакцію</a>, щоб додати 1к4 до результату, потенційно перетворюючи невдачу на успіх. Ви не можете використовувати цю реакцію, якщо ви <a href=\"/rules/conditions#condition-prone\">Повалені</a> або ваша швидкість дорівнює 0.",
    ...
    },
    {
      ...
      engName: "Rabbit Hop",
      description:
        "<a href=\"/rules/combat#order-of-combat--bonus-actions\">Бонусною дією</a> ви можете стрибнути на кількість футів, що дорівнює пʼяти вашим бонусам Майстерності, не провокуючи атаки. Ви можете використовувати цю здібність, лише якщо ваша швидкість більша за 0. Ви можете використовувати її кількість разів, що дорівнює вашому бонусу Майстерності, і відновлюєте всі витрачені використання після завершення довгого відпочинку.",
      shortDescription:
    ...
    },
    {
      ...
      engName: "Fey Gift",
      description:
        "Ви можете використати цю здібність, щоб виконати <a href=\"/rules/combat#actions-in-combat--help\">дію Допомога</a> як <a href=\"/rules/combat#order-of-combat--bonus-actions\">бонусну дію</a>, і ви можете робити це кількість разів, що дорівнює вашому бонусу Майстерності. Ви відновлюєте всі витрачені використання після завершення довгого відпочинку.\n\nПочинаючи з 3-го рівня, виберіть один з варіантів нижче кожного разу, коли ви виконуєте дію Допомога за допомогою цієї здібності:\n\nГостинність. Ви та істота, якій ви допомагаєте, отримуєте кількість <a href=\"/rules/combat#making-an-attack--temporary-hit-points\">тимчасових хіт-поінтів</a>, що дорівнює 1к6 + ваш бонус Майстерності.\n\nПрохід. Ви та істота, якій ви допомагаєте, збільшуєте вашу швидкість ходьби на 10 футів до початку вашого наступного ходу.\n\nЗлість. До початку вашого наступного ходу, коли істота, якій ви допомагаєте, вперше влучає в ціль кидком атаки, ця ціль має <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перешкоду</a> на наступний кидок атаки, який вона робить протягом наступної хвилини.",
      shortDescription:
    ...
    // ============ KENKU ============
    {
      ...
      description:
        "Завдяки вашій чудовій памʼяті, ви маєте володіння двома навичками на ваш вибір. Крім того, коли ви робите перевірку здібності, використовуючи будь-яку навичку, якою ви володієте, ви можете надати собі <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на перевірку перед киданням к20. Ви можете зробити це кількість разів, що дорівнює вашому Бонусу Майстерності, і відновлюєте всі витрачені використання після завершення довгого відпочинку.",
    ...
    },
    {
      ...
      description:
        "Коли ви копіюєте письмові роботи або ремісничі вироби, створені вами чи кимось іншим, ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на будь-які перевірки характеристик, які ви робите для створення точної копії.",
    ...
    // ============ KOBOLD ============
    {
      ...
      description:
        "<a href=\"/rules/combat#order-of-combat--bonus-actions\">Бонусною дією</a> ви можете випустити крик на своїх ворогів у межах 10 футів від вас. До початку вашого наступного ходу ви та ваші союзники маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на кидки атаки проти будь-якого з тих ворогів, хто міг вас чути. Ви можете використовувати цю здібність кількість разів, що дорівнює вашому бонусу Майстерності, і відновлюєте всі витрачені використання після завершення довгого відпочинку.",
    ...
    },
    {
      ...
      engName: "Hungry Jaws",
      description:
        "Ви можете впасти у кровожерний шал. <a href=\"/rules/combat#order-of-combat--bonus-actions\">Бонусною дією</a> ви можете здійснити спеціальну атаку своїм Укусом. Якщо атака влучає, вона завдає звичайну шкоду, і ви отримуєте <a href=\"/rules/combat#making-an-attack--temporary-hit-points\">тимчасові хіт-поінти</a>, що дорівнюють вашому Бонусу Майстерності. Ви можете використовувати цю здібність кількість разів, що дорівнює вашому бонусу Майстерності, і відновлюєте всі витрачені використання після завершення довгого відпочинку.",
    ...
    },
    {
      ...
      engName: "Goring Rush",
      description:
        "Відразу після виконання <a href=\"/rules/combat#actions-in-combat--dash\">дії Ривок</a> і руху принаймні на 20 футів прямо до цілі, ви можете вдарити її Рогами (здібність) <a href=\"/rules/combat#order-of-combat--bonus-actions\">Бонусною дією</a>.",
      shortDescription:
    ...
    },
    {
      ...
      description:
        "Коли ви використовуєте <a href=\"/rules/combat#actions-in-combat--attack\">дію Атака</a> під час свого ходу, щоб зробити рукопашну атаку, ви можете спробувати штовхнути ціль вашими рогами. Ціль не повинна бути більш ніж на один розмір більшою за вас. Якщо ви вражаєте ціль, вона повинна зробити ряткидок Сили проти СК = 8 + ваш Бонус Майстерності + ваш модифікатор Сили. При провалі ви штовхаєте ціль на 10 футів від себе.",
      shortDescription: "Штовхання після атаки",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    {
      name: "Лабіринтна памʼять",
      engName: "Labyrinthine Recall",
      description:
        "Ви завжди знаєте, де знаходиться північ, і ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на будь-яку перевірку Мудрості (Виживання), яку ви робите для навігації або відстеження.",
      shortDescription:
    ...
    // ============ ORC ============
    {
      ...
      description:
        "Ви можете виконати <a href=\"/rules/combat#actions-in-combat--dash\">дію Ривок</a> <a href=\"/rules/combat#order-of-combat--bonus-actions\">Бонусною дією</a>. Коли ви це робите, ви отримуєте кількість <a href=\"/rules/combat#making-an-attack--temporary-hit-points\">тимчасових хіт-поінтів</a>, що дорівнює вашому Бонусу Майстерності. Ви можете використовувати цю здібність кількість разів, що дорівнює вашому Бонусу Майстерності, і відновлюєте всі витрачені використання після завершення довгого відпочинку.",
    ...
    // ============ SATYR ============
    {
      ...
      description: "Ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на ряткидки проти заклять.",
    ...
    {
      name: "Дитя моря",
      engName: "Child of the Sea (Sea Elf Race)",
      description:
    ...
    {
      name: "Друг моря",
      engName: "Friend of the Sea (Sea Elf Race)",
      description:
    ...
    // ============ SHADAR-KAI ============
    {
      ...
      engName: "Blessing of the Raven Queen (Shadar-kai Race)",
      description:
        "<a href=\"/rules/combat#order-of-combat--bonus-actions\">Бонусною дією</a> ви можете магічно телепортуватися на відстань до 30 футів у вільний простір, який ви бачите. Починаючи з 3 рівня, після телепортації ви маєте опір до всіх видів шкоди до початку вашого наступного ходу, а ваш зовнішній вигляд стає примарним та напівпрозорим. Ви можете використовувати цю здібність кількість разів, що дорівнює вашому Бонусу Майстерності, і відновлюєте всі витрачені використання після завершення довгого відпочинку.",
    ...
    },
    {
      ...
      engName: "Necrotic Resistance (Shadar-kai Race)",
    ...
    // ============ SHIFTER ============
    {
      ...
      engName: "Shifting",
      description:
        "<a href=\"/rules/combat#order-of-combat--bonus-actions\">Бонусною дією</a> ви можете прийняти більш звіряче вигляд. Ця трансформація триває 1 хвилину, до вашої смерті або до того, як ви вимкнете її Бонусною дією. Коли ви перетворюєтесь, ви отримуєте <a href=\"/rules/combat#making-an-attack--temporary-hit-points\">тимчасові хіт-поінти</a>, що дорівнюють вашому рівню + ваш модифікатор Статури (мінімум 1). Ви також отримуєте додаткові переваги, які залежать від вашої підраси шифтера. Після використання цієї здібності ви не можете використовувати її знову, доки не завершите короткий або довгий відпочинок.",
    ...
    // ============ TORTLE ============
    {
      ...
      description:
        "Ви можете втягнутися у свій панцир Дією. До того, як ви вийдете, ви отримуєте +4 бонус до КБ, і ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на ряткидки Сили та Статури. Перебуваючи у своєму панцирі, ви вважаєтесь лежачим, ваша швидкість 0 і не може збільшуватися, ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перешкоду</a> на ряткидки Спритності, ви не можете виконувати <a href=\"/rules/combat#reactions--reactions\">реакції</a>, і єдина дія, яку ви можете виконати, це <a href=\"/rules/combat#order-of-combat--bonus-actions\">Бонусна дія</a>, щоб вийти з панцира.",
    ...
    },
    {
      ...
      description:
        "Завдяки вашому містичному звʼязку з природою, ви отримуєте володіння однією з наступних навичок на ваш вибір: Поводження з тваринами, Медицина, Природа, Уважність, Непомітність або Виживання.",
    ...
    // ============ TRITON ============
    {
      ...
      description:
        "Ви можете один раз використати заклинання <a href=\"/spells/fog-cloud\">Туманна хмара [Fog Cloud]</a>. Коли ви досягаєте 3-го рівня, ви можете один раз використати замовляння <a href=\"/spells/gust-of-wind\">Порив вітру [Gust of Wind]</a>. Коли ви досягаєте 5-го рівня, ви також можете один раз використати заклинання <a href=\"/spells/water-walk\">Ходіння по воді [Water Walk]</a>. Після використання цих заклять ви не можете використовувати їх знову, доки не завершите довгий відпочинок. Ви також можете використовувати ці заклинання, використовуючи будь-які слоти заклинань відповідного рівня, які у вас є. Інтелект, Мудрість або Харизма є вашою характеристикою для цих заклинань, коли ви використовуєте їх цією здібністю (ви обираєте при виборі цієї раси).",
      shortDescription:
        "<a href=\"/spells/fog-cloud\">Туманна хмара [Fog Cloud]</a>, <a href=\"/spells/gust-of-wind\">Порив вітру [Gust of Wind]</a>, <a href=\"/spells/water-walk\">Ходіння по воді [Water Walk]</a>",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      givesSpells: {
        connect: [
    ...
    // ============ YUAN-TI ============
    {
      ...
      description:
        "Ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на ряткидки, які ви робите, щоб уникнути або завершити стан отруєння на собі. Ви також маєте опір до отруйної шкоди.",
    ...
    },
    {
      ...
      description:
        "Ви знаєте замовляння <a href=\"/spells/poison-spray\">Отруйні бризки [Poison Spray]</a>. Ви можете використовувати заклинання <a href=\"/spells/animal-friendship\">Дружба з тваринами [Animal Friendship]</a> необмежену кількість разів за допомогою цієї здібності, але ви можете націлювати ним лише змій. Починаючи з 3-го рівня, ви також можете використовувати заклинання <a href=\"/spells/suggestion\">Навіювання [Suggestion]</a> за допомогою цієї здібності. Після використання ви не можете використовувати його знову, доки не завершите довгий відпочинок. Ви також можете використовувати його, використовуючи будь-які слоти заклинань 2-го рівня або вище, які у вас є. Інтелект, Мудрість або Харизма є вашою характеристикою для цих заклинань, коли ви використовуєте їх цією здібністю (ви обираєте при виборі цієї раси).",
      shortDescription:
        "<a href=\"/spells/poison-spray\">Отруйні бризки [Poison Spray]</a>, <a href=\"/spells/animal-friendship\">Дружба з тваринами [Animal Friendship]</a> (змії), <a href=\"/spells/suggestion\">Навіювання [Suggestion]</a>",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      usesCount: 1,
      givesSpells: {
    ...
    // ASTRAL ELF
    {
      ...
      engName: "Astral Fire",
      description:
        "Ви знаєте один з наступних замовлянь на вибір: <a href=\"/spells/dancing-lights\">Мерехтливі вогники [Dancing Lights]</a>, <a href=\"/spells/light\">Світло [Light]</a> або <a href=\"/spells/sacred-flame\">Священне полумʼя [Sacred Flame]</a>. Характеристика закляття - Інтелект, Мудрість або Харизма (на ваш вибір при виборі раси).",
      shortDescription:
        "1 замовляння: <a href=\"/spells/dancing-lights\">Мерехтливі вогники [Dancing Lights]</a>/<a href=\"/spells/light\">Світло [Light]</a>/<a href=\"/spells/sacred-flame\">Священне полумʼя [Sacred Flame]</a>",
      displayType: [FeatureDisplayType.PASSIVE],
    ...
    },
    {
      ...
      description:
        "<a href=\"/rules/combat#order-of-combat--bonus-actions\">Бонусною дією</a> ви можете магічно телепортуватися на відстань до 30 футів у вільний простір, який бачите. Можете використовувати цю здатність кількість разів, рівну вашому бонусу майстерності, і відновлюєте всі витрачені використання після довгого відпочинку.",
    ...
    },
    {
      ...
      description:
        "Якщо на вас застосовують заклинання <a href=\"/spells/mending\">Лагодження [Mending]</a>, ви можете витратити Кубик Хітів, кинути її та відновити кількість хітів, рівну результату кидка + ваш модифікатор Статури (мінімум 1). Крім того, ваш творець створив вас так, щоб на вас діяли заклинання, які зберігають життя, але зазвичай не впливають на Конструкти: <a href=\"/spells/cure-wounds\">Лікування ран [Cure Wounds]</a>, <a href=\"/spells/healing-word\">Цілюще слово [healing word]</a>, <a href=\"/spells/mass-cure-wounds\">Масове лікування ран [Mass Cure Wounds]</a>, <a href=\"/spells/mass-healing-word\">Масове цілюще слово [Mass Healing Word]</a> та <a href=\"/spells/spare-the-dying\">Милість до вмирущого [Spare the Dying]</a>.",
      shortDescription: "<a href=\"/spells/mending\">Лагодження [Mending]</a> лагодить конструкт, і заклинання зцілення на вас діють",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    {
      ...
      description:
        "Ви маєте опір до отруйної шкоди та імунітет до хвороб, маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на ряткидки проти Паралічу та Отруєння. Вам не потрібно їсти, пити або дихати.",
      shortDescription:
    ...
    },
    {
      ...
      engName: "Hippo Build",
      description:
        "Ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на перевірки характеристик, що базуються на Силі, та ряткидки Сили. Крім того, ви вважаєтесь на один розмір більшим при визначенні вашої вантажопідйомності та ваги, яку ви можете штовхати, тягнути або піднімати.",
      shortDescription:
    ...
    // HADOZEE
    {
      ...
      description:
        "<a href=\"/rules/combat#order-of-combat--bonus-actions\">Бонусною дією</a> ви можете використовувати ноги для маніпулювання обʼєктом, відкриття або закриття дверей чи контейнерів, підняття або встановлення крихітного обʼєкта.",
    ...
    },
    {
      ...
      engName: "Glide",
      description:
        "Коли ви падаєте з висоти щонайменше 10 футів над землею, ви можете використати свою <a href=\"/rules/combat#reactions--reactions\">реакцію</a>, щоб розправити свої шкірні мембрани та планерувати горизонтально на кількість футів, що дорівнює вашій швидкості ходьби, і ви отримуєте 0 шкоди від падіння. Ви визначаєте напрямок планерування.",
      shortDescription:
    ...
    },
    {
      ...
      description:
        "Магія, що тече у ваших жилах, підсилює природний захист. Коли отримуєте пошкодження, можете <a href=\"/rules/combat#reactions--reactions\">реакцією</a> кинути к6, додати бонус майстерності та зменшити отримані пошкодження на цю суму (мінімум 0). Ви можете використовувати цю здатність кількість разів, що дорівнює вашому Бонусу Майстерності. Ви відновлюєте всі витрачені використання після завершення довгого відпочинку.",
...

    {
      ...
      engName: "Shape Self",
      description:
        "Дією ви можете змінити форму свого тіла, щоб отримати голову, одну або дві руки, одну або дві ноги та імпровізовані кисті й стопи, або ви можете повернутися до безкінцівкової краплі. Поки ви маєте людиноподібну форму, ви можете носити одяг та обладунки, створені для Гуманоїда вашого розміру. <a href=\"/rules/combat#order-of-combat--bonus-actions\">Бонусною дією</a> ви можете випустити псевдоподію завширшки до 15 см і завдовжки до 10 футів або поглинути її назад у своє тіло. Як частина тієї самої бонусної дії ви можете використовувати цю псевдоподію, щоб маніпулювати обʼєктом, відкривати або закривати двері чи контейнер, або підбирати чи опускати Крихітний обʼєкт. Псевдоподія не містить сенсорних органів і не може атакувати, активувати магічні предмети або піднімати більше 5 кіло.",
    ...
    },
    {
      ...
      engName: "Amorphous",
      description:
        "Ви можете протиснутися через простір завширшки лише 2.5 см, за умови, що ви нічого не носите і не несете. Ви також маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на перевірки характеристик, які ви робите, щоб ініціювати або втекти із захоплення.",
      shortDescription:
    ...
    },
    {
      ...
      description:
        "Ви маєте опір до шкоди кислотою та отрутою, і ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на ряткидки проти отруєння.",
      shortDescription:
    ...
    // THRI-KREEN
    {
      ...
      description:
        "Поки не носите обладунки, ваш панцир дає базовий Клас Броні 13 + модифікатор Спритності. Дією можете змінити колір панциру, отримуючи <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на перевірки Спритності (Непомітність) для переховування у відповідному середовищі.",
    ...
    },
    {
      ...
      description:
        "Маєте дві трохи менші вторинні руки під основною парою. Вторинні руки можуть маніпулювати обʼєктом, відкривати/закривати двері, піднімати крихітні обʼєкти або тримати зброю з властивістю легка.",
    ...
    },
    {
      ...
      engName: "Taunt",
      description:
        "Ви маєте надзвичайну здатність збивати з пантелику істот. <a href=\"/rules/combat#order-of-combat--bonus-actions\">Бонусною дією</a> ви можете випустити шквал провокаційних слів на істоту в межах 60 футів від вас, яка може вас чути і розуміти. Ціль повинна здійснити ряткидок Мудрості, або вона матиме <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перешкоду</a> на кидки атаки проти цілей, окрім вас, до початку вашого наступного ходу. СК дорівнює 8 + ваш Бонус Майстерності + ваш модифікатор Інтелекту, Мудрості або Харизми (ви обираєте при виборі цієї раси). Ви можете використовувати цю бонусну дію кількість разів, що дорівнює вашому Бонусу Майстерності, і відновлюєте всі витрачені використання після завершення довгого відпочинку.",
    ...
    },
    {
      ...
      description:
        "Будь-яка істота, яка захоплює вас або іншим чином вступає в прямий контакт з вашою шкірою, повинна здійснити ряткидок Статури зі СК 12 або стати <a href=\"/rules/conditions#condition-poisoned\">отруєною</a> на 1 хвилину. Отруєна істота, яка більше не контактує з вами безпосередньо, може повторити ряткидок наприкінці кожного зі своїх ходів, завершуючи ефект на собі при успіху. \n \n Ви також можете застосувати цю отруту до будь-якої колячої зброї як частину атаки цією зброєю, хоча коли ви влучаєте, отрута реагує інакше. Ціль повинна успішно виконати ряткидок Статури зі СК 12, або отримати 2к4 шкоди отрутою.\n",
      shortDescription:
    ...
    },
    {
      ...
      description:
        "Якщо ви не зануритеся у воду принаймні на 1 годину протягом дня, ви отримуєте один рівень <a href=\"/rules/conditions#condition-exhaustion\">виснаження</a> наприкінці цього дня. Ви можете відновити рівні виснаження, отримані таким чином, лише зануренням у воду принаймні на 1 годину.",
    ...
    },
    {
      ...
      description:
        "Ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на ряткидки проти того, щоб бути Зачарованим, Переляканим, <a href=\"/rules/conditions#condition-paralyzed\">Паралізованим</a>, <a href=\"/rules/conditions#condition-poisoned\">Отруєним</a>, <a href=\"/rules/conditions#condition-stunned\">Приголомшеним</a> або Приспаним.",
    ...
    },
    {
      ...
      description:
        "Ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на ряткидки проти того, щоб бути Зачарованим або Переляканим.",
    ...
    },
    {
      ...
      engName: "Keen Smell",
      description:
        "Завдяки вашому чутливому хоботу, ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на перевірки Мудрості (Уважність), Мудрості (Виживання) та Інтелекту (Розслідування), які включають нюх.",
    ...
    // ============ VEDALKEN (GGTR) ============
    {
      ...
      description:
        "Ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на всі ряткидки Інтелекту, Мудрості та Харизми.",
    ...
    // ============ VERDAN (ACQUISITIONS INCORPORATED) ============
    {
      ...
      description:
        "Чорна кров, що є ознакою звʼязку вашого народу з Тим-Що-Витримує, посилює ваше природне зцілення. Коли ви викидаєте 1 або 2 на будь-якому Кубику хітів, який ви витрачаєте наприкінці короткого відпочинку, ви можете перекинути кубик і повинні використати новий результат.",
    ...
    },
    {
      ...
      description:
        "Звʼязок вашого розуму зі світом навколо вас зміцнює вашу волю. Ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на всі ряткидки Мудрості та Харизми.",
    ...
    // ============ KALASHTAR (EBERRON) ============
    {
      ...
      engName: "Dual Mind",
      description: "Ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на всі ряткидки Мудрості.",
    ...
    },
    {
      ...
      shortDescription:
        "Телепатія на відстані 10 × рівень футів + двосторонній звʼязок",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    {
      ...
      description:
        "Калаштари сплять, але вони не зʼєднуються з планом снів, як це роблять інші істоти. Замість цього їхні розуми черпають зі спогадів їхнього потойбічного духа під час сну. Таким чином, ви імунні до магічних заклинань та ефектів, що вимагають від вас бачити сни, як-от заклинання <a href=\"/spells/dream\">Сновидіння [Dream]</a>, але не до заклинань та ефектів, що присипляють вас, як-от заклинання <a href=\"/spells/sleep\">Сон [Sleep]</a>.",
    ...
    // ============ WARFORGED (EBERRON) ============
    {
      ...
      description:
        "Ви були створені, щоб мати чудову витривалість. Ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на ряткидки проти того, щоб бути <a href=\"/rules/conditions#condition-poisoned\">Отруєним</a>, і ви маєте опір до отруйної шкоди. Ви маєте імунітет до хвороб. Вам не потрібно їсти, пити або дихати. Вам не потрібно спати, і магія не може приспати вас.",
      shortDescription:
    ...
    // ============ HEXBLOOD (VAN RICHTEN'S) ============
    {
      ...
      engName: "Eerie Token",
      description:
        "<a href=\"/rules/combat#order-of-combat--bonus-actions\">Бонусною дією</a> ви можете безпечно видалити пасмо свого волосся, один зі своїх нігтів або один зі своїх зубів. Цей токен насичений магією, доки ви не завершите довгий відпочинок. Поки токен насичений таким чином, ви можете виконувати ці дії:\n\nТелепатичне повідомлення: Дією ви можете надіслати телепатичне повідомлення істоті, що тримає або несе токен, за умови, що ви знаходитесь у межах 10 миль від нього. Повідомлення може містити до двадцяти пʼяти слів.\n\nВіддалений перегляд: Якщо ви знаходитесь у межах 10 миль від токена, ви можете увійти в транс дією. Транс триває 1 хвилину, але закінчується раніше, якщо ви зупиняєте його (дія не потрібна) або стаєте <a href=\"/rules/conditions#condition-incapacitated\">недієздатним</a>. Під час цього трансу ви можете бачити і чути від токена так, ніби ви знаходитесь там, де він є. Поки ви використовуєте свої чуття в місці розташування токена, ви сліпі та глухі до свого власного оточення. Коли транс закінчується, токен безпечно знищується.\n\nПісля того, як ви створили токен за допомогою цієї здібності, ви не можете зробити це знову, доки не завершите довгий відпочинок, після чого ваша відсутня частина відростає.",
      shortDescription:
    ...
    },
    {
      ...
      engName: "Hex Magic",
      description:
        "Ви можете накласти заклинання <a href=\"/spells/disguise-self\">Маскування [Disguise Self]</a> та <a href=\"/spells/hex\">Проклін [Hex]</a> цією здібністю. Після того, як ви наклали одне з цих заклинань цією здібністю, ви не можете накласти це заклинання нею знову, доки не завершите довгий відпочинок. Ви також можете накладати ці заклинання, використовуючи будь-які слоти заклинань, які у вас є.\n\nІнтелект, Мудрість або Харизма є вашою характеристикою для накладання цих заклинань (виберіть характеристику, коли обираєте расу).",
      shortDescription:
        "<a href=\"/spells/disguise-self\">Маскування [Disguise Self]</a> та Прокляття [Hex] раз на відпочинок",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      givesSpells: {
    ...
    },
    {
      ...
      shortDescription: "<a href=\"/spells/detect-magic\">Виявлення магії [Detect Magic]</a> та <a href=\"/spells/detect-thoughts\">Виявлення думок [Detect Thoughts]</a> 1 раз на день",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      usesCount: 1,
    },
    ...
    },
    {
      ...
      engName: "Headwinds",
      description:
        'Ви знаєте замовляння <a href="/spell/1416">Порив [Gust]</a>. Починаючи з 3-го рівня, ви можете використовувати заклинання <a href="/spell/1267">Порив вітру [Gust of Wind]</a>, яке потребує <a href="/rules/spellcasting#concentration-rules">концентрації</a>. Після використання ви не можете використовувати його знову, доки не завершите довгий відпочинок. Харизма є вашою заклинальною характеристикою для цих заклинань.',
      shortDescription:
        "Замовляння Порив [Gust] + <a href=\"/spells/gust-of-wind\">Порив вітру [Gust of Wind]</a> 1/день",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      usesCount: 1,
    },
...

    {
      ...
      description:
        "Як <a href=\"/rules/combat#order-of-combat--bonus-actions\">бонусну дію</a> ви можете прийняти більш звірячу форму. Ця трансформація триває 1 хвилину, до вашої смерті або до того, як ви відмінюєте її бонусною дією. Коли ви перевертаєтесь, ви отримуєте тимчасові хіт-пойнти, рівні 1к6 + ваш модифікатор Статури (мінімум 1). Під час перевертання ви отримуєте бонус +1 до Класу Броні.",
    ...
    },
    {
      ...
      description:
        "Як <a href=\"/rules/combat#order-of-combat--bonus-actions\">бонусну дію</a> ви можете прийняти більш звірячу форму. Ця трансформація триває 1 хвилину, до вашої смерті або до того, як ви відмінюєте її бонусною дією. Коли ви перевертаєтесь, ви отримуєте тимчасові хіт-пойнти, рівні 1к6 + ваш модифікатор Статури (мінімум 1). Під час перевертання ви маєте <a href=\"/rules/abilities#advantage-and-disadvantage--advantage-and-disadvantage\">перевагу</a> на перевірки Мудрості, і жодна істота в межах 30 футів від вас не може отримати перевагу на кидки атаки против вас, якщо ви не втратили свідомість.",
    ...
    },
    {
      ...
      shortDescription: "<a href=\"/spells/alarm\">Тривога [Alarm]</a>, <a href=\"/spells/mage-armor\">Обладунок мага [Mage Armor]</a>, <a href=\"/spells/arcane-lock\">Арканний замок [Arcane Lock]</a> 1 раз на день",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      usesCount: 1,
    },
    ...
    },
    {
      ...
      shortDescription: "<a href=\"/spells/cure-wounds\">Лікування ран [Cure Wounds]</a> та <a href=\"/spells/lesser-restoration\">Мале відновлення [Lesser Restoration]</a> 1 раз на день",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      usesCount: 1,
    },
    ...
    },
    {
      ...
      shortDescription:
        "<a href=\"/spells/prestidigitation\">Штукарство [Prestidigitation]</a>, <a href=\"/spells/purify-food-and-drink\">Очищення їжі та напоїв [Purify Food and Drink]</a> і <a href=\"/spells/goodberry\">Доброягода [Goodberry]</a> 1 раз на день",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      usesCount: 1,
    },
    ...
    },
    {
      ...
      description:
        'Ви знаєте замовляння <a href="/spell/1344">Повідомлення [Message]</a>. Ви також можете використовувати заклинання <a href="/spell/1315">Розуміння мов [Comprehend Languages]</a> по одному разу за допомогою цієї риси. Починаючи з 3-го рівня, ви також можете використовувати заклинання <a href="/spell/1282">Магічні вуста [Magic Mouth]</a> по одному разу за допомогою цієї риси. Після того, як ви використали <a href="/spells/comprehend-languages">Розуміння мов [Comprehend Languages]</a> або <a href="/spells/magic-mouth">Магічні вуста [Magic Mouth]</a> за допомогою цієї риси, ви не можете використовувати це заклинання знову, доки не завершите довгий відпочинок. Інтелект є вашою заклинальною характеристикою для цих заклинань.',
      shortDescription: "<a href=\"/spells/message\">Повідомлення [Message]</a>, <a href=\"/spells/comprehend-languages\">Розуміння мов [Comprehend Languages]</a> та <a href=\"/spells/magic-mouth\">Магічні вуста [Magic Mouth]</a> 1 раз на день",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      usesCount: 1,
    },
    ...
    },
    {
      ...
      shortDescription: "<a href=\"/spells/hunters-mark\">Мисливська мітка [Hunter's Mark]</a> та <a href=\"/spells/locate-object\">Пошук предмета [Locate Object]</a> 1 раз на день",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      usesCount: 1,
    },
    ...
    },
    {
      ...
      shortDescription:
        "<a href=\"/spells/animal-friendship\">Дружба з тваринами [Animal Friendship]</a>, <a href=\"/spells/speak-with-animals\">Розмова з тваринами [Speak with Animals]</a> та <a href=\"/spells/beast-bond\">Звірячі узи [Beast Bond]</a> 1 раз на день",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      usesCount: 1,
    },
    {
      ...
      description:
        "Коли ви накладаєте заклинання <a href=\"/spells/animal-friendship\">Дружба з тваринами [Animal Friendship]</a> або <a href=\"/spells/speak-with-animals\">Розмова з тваринами [Speak with Animals]</a>, ви можете націлюватися на Істот (Monstrosity), якщо їхній показник Інтелекту 3 або нижче.",
    ...
    },
    {
      ...
      shortDescription: "Ви знаєте <a href=\"/spells/mending\">Лагодження [Mending]</a>",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    {
    ...
    },
    {
      ...
      description:
        'Ви можете використовувати заклинання <a href="/spell/1247">Туманний крок [Misty Step]</a> як <a href="/rules/combat#order-of-combat--bonus-actions">бонусну дію</a>. Починаючи з 3-го рівня, ви також можете використовувати заклинання <a href="/spell/1327">Негайний відступ [Expeditious Retreat]</a>. Після того, як ви використали будь-яке з цих заклинань за допомогою цієї риси, ви не можете використовувати його знову, доки не завершите довгий відпочинок. Харизма є вашою заклинальною характеристикою для цих заклинань.',
      shortDescription: "<a href=\"/spells/misty-step\">Туманний крок [Misty Step]</a> та <a href=\"/spells/expeditious-retreat\">Негайний відступ [Expeditious Retreat]</a> 1 раз на день",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      usesCount: 1,
    },
    ...
    },
    {
      ...
      description:
        'Ви можете використовувати заклинання <a href="/spell/1302">Щит [Shield]</a>. Починаючи з 3-го рівня, ви також можете використовувати заклинання <a href="/spell/1274">Охоронний звʼязок [Warding Bond]</a>. Після того, як ви використали будь-яке з цих заклинань за допомогою цієї риси, ви не можете використовувати його знову, доки не завершите довгий відпочинок. Мудрість є вашою заклинальною характеристикою для цих заклинань.',
      shortDescription: "<a href=\"/spells/shield\">Щит [Shield]</a> та <a href=\"/spells/warding-bond\">Охоронний звʼязок [Warding Bond]</a> 1 раз на день",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      usesCount: 1,
    },
    {
      ...
      description:
        "Коли істота, яку ви бачите в межах 5 футів від вас, отримує влучання атакою, ви можете використати свою <a href=\"/rules/combat#reactions--reactions\">реакцію</a>, щоб магічно помінятися місцями з цією істотою. Ви отримуєте влучання цією атакою замість неї. Ви не можете використовувати цю здатність знову, доки не завершите довгий відпочинок.",
    ...
    },
    {
      ...
      description:
        'Якщо ви маєте здатність Spellcasting або Pact Magic, заклинання в цьому списку додаються до списку заклинань вашого класу: <a href="/spell/1495">Виклик на дуель [Compelled Duel]</a>, <a href="/spell/1301">Щит віри [Shield of Faith]</a>, <a href="/spell/1259">Підтримка [Aid]</a>, <a href="/spell/1274">Охоронний звʼязок [Warding Bond]</a>, <a href="/spell/1236">Захист від енергії [Protection from Energy]</a>, <a href="/spell/1193">Захист від смерті [Death Ward]</a>, <a href="/spell/1203">Вартовий віри [Guardian of Faith]</a>.',
      shortDescription: "Розширений список заклинань",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    ...
    },
    {
      ...
      shortDescription: "<a href=\"/spells/minor-illusion\">Мала ілюзія [Minor Illusion]</a> та <a href=\"/spells/invisibility\">Невидимість [Invisibility]</a> 1 раз на день",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      usesCount: 1,
    },
...
export function readRaceFeatureSeedInputs(): SeedFeatureCreateInput[] {
  return RACE_FEATURE_SEED_INPUTS;
}

export const seedRaceFeatures = async (prisma: PrismaClient) => {
  console.log("🌟 Додаємо базові расові фічі...");

  const features = RACE_FEATURE_SEED_INPUTS;
