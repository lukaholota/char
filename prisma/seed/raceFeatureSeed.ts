...
export const seedRaceFeatures = async (prisma: PrismaClient) => {
  ...
  const features: SeedFeatureCreateInput[] = [
    ...
    // ASTRAL ELF
    {
      ...
      engName: "Astral Fire",
      description:
        "Ви знаєте один з наступних замовлянь на вибір: Мерехтливі вогники [Dancing Lights], Світло [Light] або Священне полумʼя [Sacred Flame]. Характеристика закляття - Інтелект, Мудрість або Харизма (на ваш вибір при виборі раси).",
      shortDescription:
        "1 замовляння: Мерехтливі вогники [Dancing Lights]/Світло [Light]/Священне полумʼя [Sacred Flame]",
      displayType: [FeatureDisplayType.PASSIVE],
