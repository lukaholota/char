// Ці файли звіряють наш контент із дзеркалом 5etools — `data/5etools/raw/`, яке лежить у
// .gitignore і стягується локально (`bun run fetch:5etools`). На раннері його немає взагалі,
