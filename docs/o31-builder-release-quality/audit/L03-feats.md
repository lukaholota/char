...
Це не суперечить Р33: Р33 знімає обмеження **категорії**, а тут порушена **передумова риси**.
...
- **Категорії й хто де бере рису.** `src/rules/repeatable-feats.ts:74-84` +
  ...
  крок бойового стилю — тільки `FIGHTING_STYLE`, класовий ASI — будь-яка (Р33). Сервер відхиляє
  з людською причиною («Рису «…» не можна взяти на цьому кроці»). Це відповідає Р33.
